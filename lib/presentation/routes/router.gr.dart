...
class HeadwordEntriesViewRoute
  ...
  HeadwordEntriesViewRoute({required _i8.DictionaryWord word})
      : super(name,
            path: '/headword-entries-view',
...
class LexicalEntryViewRoute
  ...
  LexicalEntryViewRoute(
      {required _i9.HeadwordEntry headwordEntry,
      required _i10.LexicalEntry lexicalEntry,
      required int headwordEntryNumber})
      : super(name,
            path: '/lexical-entry-view',
...
class SubsenseDetailsViewRoute
  ...
  SubsenseDetailsViewRoute(
      {_i2.Key? key,
      required _i9.HeadwordEntry headwordEntry,
      required _i11.KtList<_i12.Sense> subsenses,
      required String parentSenseDefinition,
      required int headwordEntryNumber})
      : super(name,
            path: '/subsense-details-view',
