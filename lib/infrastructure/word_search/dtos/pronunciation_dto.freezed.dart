...
class _$PronunciationDtoTearOff {
  ...
  _PronunciationDto call({required String audioFile}) {
...
class _$_PronunciationDto implements _PronunciationDto {
  const _$_PronunciationDto({required this.audioFile});
...
abstract class _PronunciationDto implements PronunciationDto {
  const factory _PronunciationDto({required String audioFile}) =
      _$_PronunciationDto;
