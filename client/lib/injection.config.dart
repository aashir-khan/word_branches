...
import 'domain/favorited_words/i_favorited_words_local_data_source.dart' as _i17;
...
import 'infrastructure/favorited_words/favorited_words_local_data_source.dart' as _i18;
...
import 'infrastructure/word_search/word_search_remote_data_source_fake.dart' as _i13;
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String environment, _i2.EnvironmentFilter environmentFilter}) {
  ...
  gh.lazySingleton<_i5.DictionaryWordDao>(() => _i5.DictionaryWordDao(), registerFor: {_development});
  gh.lazySingleton<_i6.Dio>(() => injectableModule.dio);
  gh.factory<_i8.FavoritedWordsViewModel>(() => _i8.FavoritedWordsViewModel());
  gh.lazySingleton<_i9.HeadwordEntryDao>(() => _i9.HeadwordEntryDao(), registerFor: {_development});
  gh.lazySingleton<_i10.INetworkInfo>(() => _i11.NetworkInfoImpl(get<_i4.Connectivity>()));
  gh.lazySingleton<_i12.IWordSearchRemoteDataSource>(
      () => _i13.WordSearchRemoteDataSourceFake(
          dictionaryWordDao: get<_i5.DictionaryWordDao>(), headwordEntryDao: get<_i9.HeadwordEntryDao>()),
      registerFor: {_test});
  gh.lazySingleton<_i12.IWordSearchRemoteDataSource>(
      () => _i14.WordSearchRemoteDataSource(dio: get<_i6.Dio>(), envVariables: get<_i7.EnvVariables>()),
      registerFor: {_production, _development});
  gh.lazySingleton<_i15.NavigationService>(() => injectableModule.navigationService);
  gh.lazySingleton<_i16.WordSearchDao>(() => _i16.WordSearchDao());
  gh.lazySingleton<_i17.IFavoritedWordsLocalDataSource>(
      () => _i18.FavoritedWordsLocalDataSource(wordSearchDao: get<_i16.WordSearchDao>()));
  gh.lazySingleton<_i19.IFavoritedWordsRepository>(
      () => _i20.FavoritedWordsRepository(localDataSource: get<_i17.IFavoritedWordsLocalDataSource>()));
  gh.lazySingleton<_i21.IWordSearchLocalDataSource>(
      () => _i22.DictionaryWordSearchLocalDataSource(wordSearchDao: get<_i16.WordSearchDao>()));
